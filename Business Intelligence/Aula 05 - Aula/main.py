...
st.sidebar.header("Filtro de Ações")
...
intervalo_datas = st.sidebar.slider("Selecione as datas", min_value=data_inicial, max_value=data_final, value=(data_inicial, data_final),step=timedelta(days=30))
